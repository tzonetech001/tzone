<?php
// exams.php - Display exams coming soon page
session_start();
    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="coming-soon-card">
                ...
                <h1 class="coming-soon-title">Exams Management</h1>
                <p class="coming-soon-text">
                    We are developing a comprehensive exam management system.<br>
                    Create, manage, and analyze exams with ease.
                </p>
                ...
                <div class="progress-container">
                    ...
                    <p class="text-muted mt-2 small">Coming Soon</p>
                </div>
