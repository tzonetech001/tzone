<?php
// subject_entry_five.php - Form Five results entry for assigned teachers
session_start();
...
// Verify teacher has permission for this subject in Form Five
...
if (!$current_assignment) {
    $_SESSION['error'] = "You don't have permission to enter results for this subject in Form Five.";
    header("Location: subject_entry.php");
    exit();
}

// Get ACTIVE exam types for Form Five
$exam_types_sql = "SELECT * FROM exam_types 
                   WHERE form_level = 'Form Five' 
                   AND is_active = 1
...
// Combination subjects mapping for Form Five
...
if (empty($exam_types)) {
    ...
    <head>
        ...
        <title>No Active Exam - Form Five</title>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajax_save'])) {
    ...
    $permission_check = "SELECT id FROM subject_teacher_assignments 
                         ...
                         AND form_level = 'Form Five' AND academic_year = $current_year
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title><?php echo $subject_display[$current_subject]; ?> - Form Five Results Entry</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
    <style>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="teacher-info-card">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                    ...
                    <div>
                        ...
                        <i class="fas fa-graduation-cap ms-3 me-1"></i> Form Five
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                <h2>
                    ...
                    <?php echo $subject_display[$current_subject]; ?> - Form Five Results Entry
                </h2>
                ...
                <table class="table results-table">
                    ...
                    <tbody>
                        <?php if (empty($students)): ?>
                            <tr><td colspan="7" class="text-center py-5">No Form Five students found.</td></tr>
                        <?php else: 
                            $sn = 1;
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#examSelector').on('change', function() { window.location.href = `subject_entry_five.php?subject=<?php echo urlencode($current_subject); ?>&exam_id=${$(this).val()}`; });
