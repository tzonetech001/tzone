...
// Get ONLY ACTIVE exam types for Form six
$exam_types_sql = "SELECT * FROM exam_types WHERE form_level = 'Form six' AND is_active = 1 ORDER BY year DESC, id DESC";
...
if (empty($exam_types)) {
    ...
    <head>
        ...
        <title>Form six Results Entry - No Active Exam</title>
        ...
        <div class="main-content">
            <div class="container-fluid">
                <div class="alert alert-warning text-center py-5">
                    ...
                    <hr>
                    <a href="exam_type_manager.php?form_level=Form%20six" class="btn btn-primary">Go to Exam Type Manager</a>
                </div>
            </div>
        </div>
    </body>
...
// Combination subjects mapping for Form six - EACH COMBINATION HAS ITS OWN SUBJECTS
...
function recalculateStudentResults($conn, $student_id, $exam_type_id) {
    ...
    // Update totals
    $update_sql = "UPDATE form_six_results 
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Form six Results Entry - Auto Save</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" rel="stylesheet">
    <style>
        :root {
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
                <h2 class="page-title">
                    ...
                    Form six Results Entry
                </h2>
                <div class="d-flex gap-2">
                    <a href="exam_type_manager.php?form_level=Form%20six" class="btn btn-outline-secondary">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#examSelector').on('change', function() {
                ...
                if (examId) {
                    window.location.href = 'results_entry_six.php?exam_id=' + examId;
                }
            });
